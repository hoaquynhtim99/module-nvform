    ...
    <div id="filefields"{DATAFORM.display_filefields}>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label"><strong>{LANG.question_options_file_multi_num}</strong></label>
                    <div class="col-sm-20">
                        <div class="form-inline">
                            <input type="number" min="1" max="20" name="file_multi_num" value="{QUESTION_CHOICES.multi_num}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
